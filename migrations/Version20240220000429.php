 ...
 */
final class Version20240220000429 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__card AS SELECT id, question, answer, category, tag, last_reviewed_at FROM card');
        ...
        $this->addSql('INSERT INTO card (id, question, answer, category, tag, last_reviewed_at) SELECT id, question, answer, category, tag, last_reviewed_at FROM __temp__card');
